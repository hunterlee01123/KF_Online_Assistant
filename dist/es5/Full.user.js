...
exports.addPromoteHaloInterval = exports.handleIndexPersonalInfo = exports.addSearchTypeSelectBox = exports.showVipSurplusTime = exports.addThreadFastGotoLink = exports.smRankChangeAlert = exports.smLevelUpAlert = exports.handleAtTips = undefined;
...
var lootAttack = exports.lootAttack = function lootAttack(_ref) {
    ...
    var attack = function attack() {
        $.ajax({
            ...
            if (Config.autoLootEnabled) {
                var nextTime = Util.getDate('+' + _Const2.default.lootAttackingExpires + 'm');
                Util.setCookie(_Const2.default.lootAttackingCookieName, nextTime.getTime(), nextTime);
            }
...
var getLootInfo = exports.getLootInfo = function getLootInfo() {
    ...
    return {
        ...
        changePointsCount: changePointsCount,
        log: log,
        logList: logList,
        enemyList: enemyList
    };
...
var getNextTimingIntervalInfo = exports.getNextTimingIntervalInfo = function getNextTimingIntervalInfo() {
    ...
    if (Config.autoLootEnabled || Config.autoSaveLootLogInSpecialCaseEnabled) {
        ...
        } else if (_value < 0) checkLootInterval = _Const2.default.checkLootInterval * 60;else {
            var _value2 = parseInt(Util.getCookie(_Const2.default.lootAttackingCookieName));
