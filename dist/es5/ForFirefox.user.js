...
var addFastNavMenu = exports.addFastNavMenu = function addFastNavMenu() {
    var $menuBtn = $('#alldiv > .drow:nth-child(2) > .dcol > .topmenuo > .topmenuo1 > .topmenuo3:last-child > a[href="fyg_sjcdwj.php?go=play"]');
...
var modifyKFOtherDomainLink = exports.modifyKFOtherDomainLink = function modifyKFOtherDomainLink() {
    $('.readtext a, .thread2 a').each(function () {
        ...
        var matches = /^(https?:\/\/(?:[\w\.]+?\.)?(?:2dgal|ddgal|9gal|9baka|9moe|kfgal|2dkf|ikfol|kfacg|fygal|bakabbs|365gal|365galgame|kforz|miaola|koyuki)\.\w+?\/)\w+\.php/i.exec(url);
