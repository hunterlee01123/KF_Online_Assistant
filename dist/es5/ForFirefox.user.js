 ...
 */
var showEnhanceLog = function showEnhanceLog(logList, pointsLogList) {
    var list = [];
 ...
 * 添加历史争夺记录导航
 */
var addHistoryLogsNav = function addHistoryLogsNav() {
 ...
 */
var getLifeInfo = function getLifeInfo(logList, level) {
    var life = 0,
        initLife = 0;
