...
var handleAtTips = exports.handleAtTips = function handleAtTips() {
    ...
    var $atTips = $('a.indbox5[href^="guanjianci.php?gjc="]');
...
var sortArmsById = exports.sortArmsById = function sortArmsById($armArea) {
    ...
    try {
        for (var _iterator9 = armIdList[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
            var armId = _step9.value;
...
var getArmParameterSetting = exports.getArmParameterSetting = function getArmParameterSetting(armId, armInfo) {
    ...
    try {
        for (var _iterator10 = smKeyList[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
    ...
    try {
        for (var _iterator11 = armInfo['主属性'][Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
    ...
    try {
        for (var _iterator12 = armInfo['从属性'][Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
    ...
    try {
        for (var _iterator13 = Util.entries(info)[Symbol.iterator](), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {
            var _step13$value = _slicedToArray(_step13.value, 2),
                key = _step13$value[0],
                _value2 = _step13$value[1];
...
var handleUselessSubProperties = exports.handleUselessSubProperties = function handleUselessSubProperties(html) {
    ...
    try {
        for (var _iterator14 = armInfo['主属性'][Symbol.iterator](), _step14; !(_iteratorNormalCompletion14 = (_step14 = _iterator14.next()).done); _iteratorNormalCompletion14 = true) {
            var _value3 = _step14.value;
    ...
    if (matches) {
        ...
        try {
            for (var _iterator15 = matches[1].split('。')[Symbol.iterator](), _step15; !(_iteratorNormalCompletion15 = (_step15 = _iterator15.next()).done); _iteratorNormalCompletion15 = true) {
...
var addCommonArmsButton = exports.addCommonArmsButton = function addCommonArmsButton($area, $armArea) {
    $('\n<label>\n  <input name="sortArmsByGroupEnabled" type="checkbox" ' + (Config.sortArmsByGroupEnabled ? 'checked' : '') + '> \u5206\u7EC4\u6392\u5217</input>\n  <span class="pd_cfg_tips" title="\u5206\u7EC4\u6392\u5217\u88C5\u5907">[?]</span>\n</label>\n<button name="selectAll" type="button" title="\u5168\u9009" style="min-width: inherit;">\u5168\u9009</button>\n<button name="selectInverse" type="button" title="\u53CD\u9009" style="min-width: inherit;">\u53CD\u9009</button>\n<button name="copyArmParameterSetting" type="button" title="\u590D\u5236\u6240\u9009\u88C5\u5907\u7684\u8BA1\u7B97\u5668\u53C2\u6570\u8BBE\u7F6E">\u590D\u5236\u88C5\u5907\u53C2\u6570</button>\n').prependTo($area).find('[name="sortArmsByGroupEnabled"]').click(function () {
        ...
        try {
            for (var _iterator16 = armInfoList[Symbol.iterator](), _step16; !(_iteratorNormalCompletion16 = (_step16 = _iterator16.next()).done); _iteratorNormalCompletion16 = true) {
 ...
 * @param {string} safeId SafeID
 */
var showArmsFinalAddition = function showArmsFinalAddition(armList, oriEquippedArmList, safeId) {
    var index = 0;
...
var showBatchSmeltArmsDialog = function showBatchSmeltArmsDialog() {
    ...
    try {
        for (var _iterator17 = armGroupList[Symbol.iterator](), _step17; !(_iteratorNormalCompletion17 = (_step17 = _iterator17.next()).done); _iteratorNormalCompletion17 = true) {
            ...
            try {
                for (var _iterator18 = armTypeList[Symbol.iterator](), _step18; !(_iteratorNormalCompletion18 = (_step18 = _iterator18.next()).done); _iteratorNormalCompletion18 = true) {
 ...
 * @param {boolean} nextActionEnabled 是否执行后续操作
 */
var smeltArms = function smeltArms(_ref4) {
    ...
    var complete = function complete() {
        ...
        try {
            for (var _iterator19 = Util.getSortedObjectKeyList(armClassList, smeltInfo)[Symbol.iterator](), _step19; !(_iteratorNormalCompletion19 = (_step19 = _iterator19.next()).done); _iteratorNormalCompletion19 = true) {
                var armClass = _step19.value;
                ...
                try {
                    for (var _iterator20 = Util.getSortedObjectKeyList(armGroupList, smeltInfo[armClass])[Symbol.iterator](), _step20; !(_iteratorNormalCompletion20 = (_step20 = _iterator20.next()).done); _iteratorNormalCompletion20 = true) {
                        var armGroup = _step20.value;
...
var showBatchUseAndSellItemsDialog = function showBatchUseAndSellItemsDialog(type) {
    ...
    try {
        for (var _iterator21 = itemTypeList.slice(6)[Symbol.iterator](), _step21; !(_iteratorNormalCompletion21 = (_step21 = _iterator21.next()).done); _iteratorNormalCompletion21 = true) {
 ...
 * @param {boolean} nextActionEnabled 是否执行后续操作
 */
var useItems = function useItems(_ref6) {
    ...
    var complete = function complete() {
        ...
        try {
            for (var _iterator22 = Util.getSortedObjectKeyList(typeList, useInfo)[Symbol.iterator](), _step22; !(_iteratorNormalCompletion22 = (_step22 = _iterator22.next()).done); _iteratorNormalCompletion22 = true) {
                ...
                if (!$.isEmptyObject(stat)) {
                    ...
                    try {
                        for (var _iterator23 = Util.entries(stat)[Symbol.iterator](), _step23; !(_iteratorNormalCompletion23 = (_step23 = _iterator23.next()).done); _iteratorNormalCompletion23 = true) {
 ...
 * @param {boolean} nextActionEnabled 是否执行后续操作
 */
var sellItems = function sellItems(_ref8) {
    ...
    var complete = function complete() {
        ...
        try {
            for (var _iterator24 = Util.getSortedObjectKeyList(typeList, sellInfo)[Symbol.iterator](), _step24; !(_iteratorNormalCompletion24 = (_step24 = _iterator24.next()).done); _iteratorNormalCompletion24 = true) {
 ...
 * @param {string} safeId SafeID
 */
var buyItems = exports.buyItems = function buyItems(buyItemIdList, safeId) {
        ...
        $.ajax({
            ...
            if (msg.includes('购买成功')) {
                ...
                if (matches) {
                    ...
                    try {
                        for (var _iterator25 = Util.entries(gain)[Symbol.iterator](), _step25; !(_iteratorNormalCompletion25 = (_step25 = _iterator25.next()).done); _iteratorNormalCompletion25 = true) {
                    ...
                    try {
                        for (var _iterator26 = Util.entries(pay)[Symbol.iterator](), _step26; !(_iteratorNormalCompletion26 = (_step26 = _iterator26.next()).done); _iteratorNormalCompletion26 = true) {
                            var _step26$value = _slicedToArray(_step26.value, 2),
                                _key2 = _step26$value[0],
            ...
            if (isStop || index >= itemIdList.length) {
                ...
                setTimeout(function () {
                    return buy(parseInt(itemIdList[index][subIndex]));
                }, _Const2.default.minActionInterval);
            }
        });
    };
    ...
    try {
        for (var _iterator27 = buyItemIdList[Symbol.iterator](), _step27; !(_iteratorNormalCompletion27 = (_step27 = _iterator27.next()).done); _iteratorNormalCompletion27 = true) {
...
var getLogStat = function getLogStat(log, date, logStatType) {
        ...
        try {
            for (var _iterator9 = rangeLog[_d][Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
                ...
                if (type === '争夺攻击' && $.type(gain) === 'object') {
                    ...
                    try {
                        for (var _iterator16 = Util.entries(gain['item'])[Symbol.iterator](), _step16; !(_iteratorNormalCompletion16 = (_step16 = _iterator16.next()).done); _iteratorNormalCompletion16 = true) {
                            var _step16$value = _slicedToArray(_step16.value, 2),
                                itemName = _step16$value[0],
                                num = _step16$value[1];
    ...
    try {
        for (var _iterator17 = Util.getSortedObjectKeyList(sortStatTypeList, income)[Symbol.iterator](), _step17; !(_iteratorNormalCompletion17 = (_step17 = _iterator17.next()).done); _iteratorNormalCompletion17 = true) {
    ...
    try {
        for (var _iterator18 = Util.getSortedObjectKeyList(sortStatTypeList, expense)[Symbol.iterator](), _step18; !(_iteratorNormalCompletion18 = (_step18 = _iterator18.next()).done); _iteratorNormalCompletion18 = true) {
            var _key5 = _step18.value;
    ...
    try {
        for (var _iterator19 = Util.getSortedObjectKeyList(sortStatTypeList, profit)[Symbol.iterator](), _step19; !(_iteratorNormalCompletion19 = (_step19 = _iterator19.next()).done); _iteratorNormalCompletion19 = true) {
            var _key6 = _step19.value;
    ...
    if (boxTotalNum > 0) {
        ...
        try {
            for (var _iterator22 = Util.entries(boxGain)[Symbol.iterator](), _step22; !(_iteratorNormalCompletion22 = (_step22 = _iterator22.next()).done); _iteratorNormalCompletion22 = true) {
                ...
                if ($.type(value) === 'object') {
                    ...
                    try {
                        for (var _iterator23 = Util.getSortedObjectKeyList(typeList, value)[Symbol.iterator](), _step23; !(_iteratorNormalCompletion23 = (_step23 = _iterator23.next()).done); _iteratorNormalCompletion23 = true) {
    ...
    try {
        for (var _iterator24 = Util.getSortedObjectKeyList(Item.itemTypeList, validItemStat)[Symbol.iterator](), _step24; !(_iteratorNormalCompletion24 = (_step24 = _iterator24.next()).done); _iteratorNormalCompletion24 = true) {
            var _itemName = _step24.value;
    ...
    try {
        for (var _iterator25 = Util.getSortedObjectKeyList(Item.itemTypeList, invalidItemStat)[Symbol.iterator](), _step25; !(_iteratorNormalCompletion25 = (_step25 = _iterator25.next()).done); _iteratorNormalCompletion25 = true) {
            var _itemName2 = _step25.value;
...
var showLogText = function showLogText(log, $dialog) {
    ...
    try {
        for (var _iterator26 = Object.keys(log)[Symbol.iterator](), _step26; !(_iteratorNormalCompletion26 = (_step26 = _iterator26.next()).done); _iteratorNormalCompletion26 = true) {
            var date = _step26.value;
...
var lootAttack = exports.lootAttack = function lootAttack(_ref) {
    ...
    var recordPointsLog = function recordPointsLog() {
        ...
        try {
            for (var _iterator4 = Util.entries(propertyList)[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
    ...
    var changePointsAndArms = function changePointsAndArms(nextLevel, callback) {
        if (nextLevel > 0 && Config.customPointsScriptEnabled && typeof _Const2.default.getCustomPoints === 'function') {
            ...
            if ($.type(points) === 'object') {
                ...
                try {
                    for (var _iterator5 = Util.entries(points)[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
                        var _step5$value = _slicedToArray(_step5.value, 2),
                            key = _step5$value[0],
                            value = _step5$value[1];
...
var promoteHalo = exports.promoteHalo = function promoteHalo(totalCount, promoteHaloCostType, safeId) {
    var isInitLootPage = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
...
var preventCloseWindowWhenEditPost = exports.preventCloseWindowWhenEditPost = function preventCloseWindowWhenEditPost() {
    window.addEventListener('beforeunload', function (e) {
        var $textArea = $(location.pathname === '/post.php' ? '#textarea' : 'input[name="atc_content"]');
...
var getUidAndUserName = exports.getUidAndUserName = function getUidAndUserName() {
    var $userName = $('.topmenuo1 > .topmenuo3:last-child > a[href="javascript:;"]').eq(0);
    var $uid = $('.topmenuo1 > .topmenuo3:last-child a[href^="profile.php?action=show&uid="]').eq(0);
...
var getNextTimingIntervalInfo = exports.getNextTimingIntervalInfo = function getNextTimingIntervalInfo() {
    ...
    if (Config.autoBuyItemEnabled) {
        ...
        var _now2 = new Date();
        if (Util.getCookie(_Const2.default.buyItemCookieName) || _now2 < _date2) {
...
var getDailyBonus = exports.getDailyBonus = function getDailyBonus() {
    ...
    $.ajax({
        ...
        var matches = /<a href="(kf_growup\.php\?ok=3&safeid=\w+)" target="_self">你可以领取\s*(\d+)KFB\s*\+\s*(\d+)经验\s*\+\s*(\d+(?:\.\d+)?)贡献\s*\+\s*(\d+)转账额度/.exec(html);
        if (matches) {
...
var addFastNavMenu = exports.addFastNavMenu = function addFastNavMenu() {
    var $menuBtn = $('.topmenuo1 > .topmenuo3:nth-last-child(2) > a:contains("本站主页")');
...
var getMultiQuoteData = exports.getMultiQuoteData = function getMultiQuoteData() {
    ...
    $('.pd_multi_quote_chk input:checked').each(function () {
        ...
        var userName = $readLou.next('div').next('.readtext').find('.readidmsbottom > a, .readidmleft > a').text();
        if (!userName) return;
