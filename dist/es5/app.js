 ...
 * 添加改点倒计时
 */
var addChangePointsCountDown = exports.addChangePointsCountDown = function addChangePointsCountDown() {
    var nextTime = parseInt(Util.getCookie(_Const2.default.changePointsCountDownCookieName));
    if (nextTime === 0) return;
    if (isNaN(nextTime)) {
        Loot.getChangePointsCountDown().done(addChangePointsCountDown).fail(function () {
            return setTimeout(addChangePointsCountDown, _Const2.default.defAjaxInterval);
        });
        return;
    }
...
var getNextTimingIntervalInfo = exports.getNextTimingIntervalInfo = function getNextTimingIntervalInfo() {
    ...
    if (Config.autoLootEnabled || Config.autoSaveLootLogInSpecialCaseEnabled) {
        ...
        if (_value > 0) {
            ...
            var _value2 = parseInt(Util.getCookie(_Const2.default.changePointsCountDownCookieName));
