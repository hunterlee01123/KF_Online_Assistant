...
// 在生命值不超过低保线时检查是否进行攻击的时间间隔列表，格式：{'距本回合开始已经过的分钟数A-距本回合开始已经过的分钟数B':间隔分钟数}，例：{'190-205': 3, '205-225': 5, '225-600': 10}
// （不在此列表里的时间段将按照Config.defCheckLifeAfterAttemptAttackInterval所设定的默认时间间隔）
Config.checkLifeAfterAttemptAttackIntervalList = {'190-205': 3, '205-225': 5, '225-600': 10};
