...
(function () {
    ...
    var replaceList = [[/(妹|mei)(子|纸|zi)/ig, '基佬'], [/她/g, '他'], [/女(生|孩|人)/g, '男$1'], [/(妹|抱|亲|吻|脱|约|恋|kiss|\bmei\b)/ig, '$1♂']];
    ...
    if (Util.getCurrentThreadPage() === 1 && replaceUserList.includes($('a[name="tpc"]').next('.readlou').next('.readtext').find('.readidmsbottom > a, .readidmleft > a').text())) {
