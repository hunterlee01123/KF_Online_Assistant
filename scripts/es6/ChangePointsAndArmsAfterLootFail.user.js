...
addFunc('Loot.lootAttack_complete_', function () {
    ...
    const type = 'targetLevel';
    // 修改为第N层的点数分配方案
    const targetLevel = 1;
    // 手动设定的点数分配方案
    const points = {"力量": 16, "体质": 19, "敏捷": 432, "灵活": 1, "智力": 300, "意志": 12, "武器ID": 1429379, "武器备注": "传奇的法杖", "护甲ID": 2572888, "护甲备注": "传奇的皮甲"};

    const Msg = require('./Msg');
    const Loot = require('./Loot');

    let {changePointsAvailableCount} = Loot.getLootInfo();
